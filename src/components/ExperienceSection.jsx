            ...
            {workExperience.map((exp) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-4 sm:p-5 border-2 transition-all font-mono-code ${
                    isActive
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className={`text-[11px] font-extrabold uppercase tracking-wider ${isActive ? 'text-[#ccff00]' : 'text-zinc-500'}`}>
                      {exp.badge}
                    </span>
            ...
            <div className="space-y-3.5 mb-8">
              ...
              <div className="space-y-2.5">
                {activeExp.highlights.map((h, i) => (
                  <div key={i} className="flex items-start gap-3 bg-[#11111a] p-3.5 border-l-2 border-[#ccff00] text-sm text-zinc-200 font-sans">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {activeExp.tags.map((tag, i) => (
                  <span
                    key={i}
                    className="text-xs font-mono-code px-3 py-1 bg-[#161622] text-[#ccff00] border border-zinc-700 hover:border-[#ccff00] transition-colors"
                  >
                    #{tag}
                  </span>
                ))}
