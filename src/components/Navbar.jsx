...
export default function Navbar() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-150 ${
      scrolled 
        ? 'bg-[#050507]/95 backdrop-blur-md border-b border-zinc-800 py-3 shadow-xl' 
        : 'bg-[#050507]/80 backdrop-blur-sm border-b border-zinc-900 py-4'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <a
            ...
            className="text-xs font-mono-code text-zinc-400 hover:text-white px-2 py-1 transition-colors"
          >
            WA: +62 821-5767-5493
          </a>
          <a
            href="#contact"
            className="flex items-center gap-1.5 text-xs font-mono-code font-bold bg-[#ccff00] text-black border border-white px-3 py-1.5 shadow-[2px_2px_0px_#000000] hover:shadow-[3px_3px_0px_#ffffff] hover:translate-y-[-1px] transition-all"
          >
            <span>DISPATCH</span>
